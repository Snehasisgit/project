                ...
                <div className="contact_inner">
                  ...
                  <div className="contact_info_sec">
                    ...
                    <div className="d-flex info_single align-items-center">
                      ...
                      <span>7769966961, 9175346961</span>
                    </div>
                    <div className="d-flex info_single align-items-center">
                      <i className="fas fa-envelope-open-text" />
                      <span>fastransbidding@gmail.com</span>
                    </div>
                    <div className="d-flex info_single align-items-center">
                      <i className="fas fa-map-marked-alt" />
                      <span> CDAC Mumbai, Near Bharati Vidyapeeth, Opp. Kharghar
                        Railway Station, Sector 7, CBD Belapur Navi Mumbai - 400
                        614 India</span>
                    </div>
                  </div>
                </div>
